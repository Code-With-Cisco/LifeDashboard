...
1. **Daily command brief (implemented baseline).** Rank open tasks, today's calendar, habit progress, and the planned workout locally. Add user-controlled focus rules and a morning delivery preference next.
